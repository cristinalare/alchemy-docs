...
{% hint style="info" %}
HINT: You'll need to install the dotenv package if you haven't already. Follow [these steps](sending-transactions-using-web3-and-alchemy.md#5-install-dotenv) to learn more. 
{% endhint %}
