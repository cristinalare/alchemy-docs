...
### Add maxPriorityFeePerGas field only \(recommended\) <a id="add-max-priority-fee-per-gas-field-only-recommended"></a>
...
I won't bore you with the output, it looks the same. The [`eth_maxPriorityFeePerGas`](../../documentation/apis/ethereum/eth_maxpriorityfeepergas.md) method is documented [here](https://docs.alchemy.com/alchemy/documentation/apis/ethereum#eth_maxpriorityfeepergas).
